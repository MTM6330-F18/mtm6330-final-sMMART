...
const web = {
  ...
  expect:
    '<h2 class="featurette-heading">Careers</h2><p class="lead">Graduates may expect to find employment in a wide variety of positions such as: production coordinator; production assistant; production director; or technical project lead.</p><h2 class="featurette-heading">Learning Outcomes</h2><p class="lead">The graduate has reliably demonstrated the ability to:</p><p class="lead">Complete both individual and collaborative interactive media projects effectively.<br>Use best practices and tools to design and develop dynamic, rich-media content.<br>Contribute to the assessment of the requirements of an interactive media project.<br>Contribute to the development, budgeting, planning and professional presentation of an interactive media project.<br>Design a media project (interface, navigation, graphics, text treatment) using current best practice design and development principles, and applying conceptual and theoretical frameworks.<br>Build effective and dynamic Web sites and/or mobile applications.<br>Identify and analyze ethical and professional issues arising in an online environment.<br>Apply research and conceptual skills to propose possible solutions for mobile/multimedia/Web development problems.<br>Use creative and critical thinking techniques in the effective design, development and implementation of an interactive media project.<br>Contribute to the assessment of the financial, technical and artistic success of an interactive media project.<br>Identify and apply discipline-specific practices that contribute to the local and global community through social responsibility, economic commitment and environmental stewardship.</p>'
}
...
const video = {
  ...
  expect:
    '<h2 class="featurette-heading">Careers</h2><p class="lead">Graduates may expect to find employment in a wide variety of positions such as: production coordinator; production assistant; production director; or technical project lead.</p><h2 class="featurette-heading">Learning Outcomes</h2><p class="lead">The graduate has reliably demonstrated the ability to:</p><p class="lead">Complete both individual and collaborative interactive media projects effectively.<br><br>Use best practices and tools to design and develop dynamic, rich-media content.<br><br>Contribute to the assessment of the requirements of an interactive media project.<br><br>Contribute to the development, budgeting, planning and professional presentation of an interactive media project.<br><br>Design a media project (interface, navigation, graphics, text treatment) using current best practice design and development principles, and applying conceptual and theoretical frameworks.<br><br>Build effective and dynamic Web sites and/or mobile applications.<br><br>Identify and analyze ethical and professional issues arising in an online environment.<br><br>Apply research and conceptual skills to propose possible solutions for mobile/multimedia/Web development problems.<br>Use creative and critical thinking techniques in the effective design, development and implementation of an interactive media project.<br><br>Contribute to the assessment of the financial, technical and artistic success of an interactive media project.<br><br>Identify and apply discipline-specific practices that contribute to the local and global community through social responsibility, economic commitment and environmental stewardship.</p>'
}
